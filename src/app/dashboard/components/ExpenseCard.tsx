...
export default function ExpenseCard() {
  return (
    <div className="w-full rounded-2xl bg-gradient-to-br bg-red-600 dark:bg-red-700 to-red-500 border border-orange-200/30 backdrop-blur-xl shadow-lg p-6 flex justify-between items-center gap-3">
