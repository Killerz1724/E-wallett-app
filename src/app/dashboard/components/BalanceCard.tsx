...
export default function BalanceCard() {
  return (
    <div className="w-full rounded-2xl bg-gradient-to-br bg-orange-500 dark:bg-orange-600  to-orange-400 border border-orange-200/30 backdrop-blur-xl shadow-lg p-6 flex flex-col gap-3">
